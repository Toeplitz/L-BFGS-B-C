...
#define setulb FORTRAN_WRAPPER(setulb)
    extern int setulb(integer *n, integer *m, double *x,
                      double *l, double *u, integer *nbd, double *f, double *g, double *factr, double *pgtol, double *wa, integer *iwa, integer *task, integer *iprint, integer *csave, logical *lsave,
...
#define mainlb FORTRAN_WRAPPER(mainlb)
    extern int mainlb(integer *n, integer *m, double *x,
                      double *l, double *u, integer *nbd, double *f, double *g, double *factr, double *pgtol, double *ws, double *wy, double *sy, double *ss, double *wt, double *wn,
...
#define subsm FORTRAN_WRAPPER(subsm)
    extern int subsm(integer *, integer *, integer *, integer *, double *, double *,
                     ...
                     double *, double *, double *, double *, integer *, integer *, integer *, double *, double *, integer *,
                     integer *);
...
#define prn2lb FORTRAN_WRAPPER(prn2lb)
    extern int prn2lb(integer *n, double *x, double *f, double *g,
                      integer *iprint, fileType itfile, integer *iter, integer *nfgv, integer *nact, double *sbgnrm, integer *nseg, integer *word, integer *iword, integer *iback, double *stp,
                      double *xstep, ftnlen);

#define prn3lb FORTRAN_WRAPPER(prn3lb)
    extern int prn3lb(integer *n, double *x, double *f, integer *task, integer *iprint, integer *info, fileType itfile, integer *iter,
...
#define lnsrlb FORTRAN_WRAPPER(lnsrlb)
    extern int lnsrlb(integer *n, double *l, double *u,
                      ...
                      double *dnorm, double *dtd, double *xstep, double *stpmx, integer *iter, integer *ifun, integer *iback, integer *nfgv,
                      integer *info, integer *task, logical *boxed, logical *cnstnd, integer *csave, integer *isave, double *dsave); /* ftnlen task_len, ftnlen 
        csave_len); */
...
#define dcsrch FORTRAN_WRAPPER(dcsrch)
    extern int dcsrch(double *f, double *g, double *stp,
                      double *ftol, double *gtol, double *xtol, double *stpmin, double *stpmax, integer *task, integer *isave, double *dsave); /* ftnlen task_len);*/
